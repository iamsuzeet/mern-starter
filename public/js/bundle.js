...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaWFtc3V6ZWV0IiwiYSI6ImNrOXo2ZzcxajA0bXczbHBlamZ6ZTk2dzMifQ.V1v_-szCYZPBptnP0gFheA';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Successfully created');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
          ...
          case 7:
            ...
            return _context.abrupt("return", (0, _alerts.showAlert)('error', 'There is already a user with current email'));
